...
class Server {
    ...
    constructor(databaseFilepath: string) {
        ...
        this.readonlyConnection.function("find_widget_regexp", { deterministic: true, varargs: false, safeIntegers: true }, find_widget_regexp)
        this.readWriteConnection.function("find_widget_regexp", { deterministic: true, varargs: false, safeIntegers: true }, find_widget_regexp)
    }
