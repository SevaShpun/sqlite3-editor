...
export const Table = () => {
    ...
    if (invalidQuery !== null) {
        return <span class="text-red-700 select-text">{invalidQuery}</span>
    }
...
/** This function should only be used for presenting the generated SQL to the user. I'm not sure if this implementation is correct, as I couldn't find any documentation on the syntax for literal-values and haven't checked the implementation of the parser. */
export const unsafeEscapeValue = (value: remote.SQLite3Value) => {
    if (value instanceof Uint8Array) {
        ...
        return `'${value.replaceAll("'", "''")}'`  // SQLite doesn't support escape sequences such as "\n".
